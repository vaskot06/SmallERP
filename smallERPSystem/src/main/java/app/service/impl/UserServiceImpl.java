...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserServiceModel findByFirstName(String firstName) {
        return this.modelMapper.map(this.userRepository.findByFirstName(firstName), UserServiceModel.class);
    }
