...
@Named
@RequestScoped
public class AssortmentDeleteBean extends BaseBean {
    ...
    public AssortmentDeleteBean() {
    }

    @Inject
    public AssortmentDeleteBean(ModelMapper modelMapper, AssortmentService assortmentService, UserService userService, CompanyService companyService) {
    ...
    public void deleteAssortment(String name) {

        AssortmentServiceModel model = assortmentService.findByName(name);

        this.assortmentService.delete(model);
